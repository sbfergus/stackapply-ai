document.addEventListener("DOMContentLoaded", async () => {
  ...
  saveBtn.addEventListener("click", async () => {
    ...
    // Spread scrapedData FIRST, then explicitly override with form values SECOND
    const payload = {
      ...scrapedData,
      title,
      company,
      location,
      workSetting: selectedWorkSetting, // Hard overrides with "IN_OFFICE"
    ...
    try {
      ...
      console.error(err);
      statusEl.innerText = "❌ Could not connect to localhost:3000";
      statusEl.className = "status error";
      saveBtn.disabled = false;
      saveBtn.innerText = "Save to Dashboard";
    }
